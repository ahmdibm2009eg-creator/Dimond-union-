      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <button onClick={() => scrollTo('home')} className="flex items-center">
            <img src="https://media.base44.com/images/public/6a75b32be1751696858b1e3d/1d102d7e0_photo_6035282697564917489_y.jpg" alt="Diamond Union" className="object-contain opacity-100 w-auto h-12" />
          </button>
